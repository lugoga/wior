...
#' Get daily chlorophyll concentration from MODIS satellite data at four kilometer spatial resolution
#'
...
#'
#' @examples
get_1dayChl = function(lon.min, lon.max, lat.min, lat.max, t1, t2){

  rerddap::griddap(x = "erdMH1chla1day",
