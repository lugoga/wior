...
#' @param type dataset of SST for day (type = 1)  for 8 day (type = 2) and monthyl composite (type = 3)
#'
#' @return a tibble dataset contain the gridded sst
#' @export
#'
#' @examples
get_sstMODIS = function(lon.min, lon.max, lat.min, lat.max, t1, t2, type = 1){
