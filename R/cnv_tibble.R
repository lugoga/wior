...
#' Convert binary vertical data to tibble
#'
...
#'
#' @return a tibble with temperature, depth conductivity as standard CTD variables and additional variables depending on the sensors configured in the insturment
#' @export
#'
#' @examples
#'
